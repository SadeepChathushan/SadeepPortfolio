        ...
        <ul className={styles.aboutItems}>
            <li className={styles.aboutItem}>
                ...
                <div className={styles.aboutItemText}>
                    ...
                    with hands-on experience from my second-year project using PHP. <br /><br />
                    ...
                    next courses in this program. <br /><br />
                    ...
                    achieved notable placements in national-level music competitions. <br /> <br />

                    In my campus life, I have actively participated in sports and have earned several 
                    certificates in inter-faculty competitions.
